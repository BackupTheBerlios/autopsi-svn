...
public class mainFrame extends javax.swing.JFrame implements java.awt.event.MouseListener,java.awt.event.MouseMotionListener,WindowListener, ActionListener{
	...
	DefaultComboBoxModel listTC2Model = new DefaultComboBoxModel(); //Listmodel f�r verwandte Termine
			...
			}
			{
				...
				mainMenu.setPreferredSize(new java.awt.Dimension(892, 24));
				{
					...
					}
					{
						...
						menu_add_Pruefung.setText("Pr�fung ...");
					}
					{
	...
	public void mouseClicked(MouseEvent arg0) {
		...
		if(arg0.getSource().equals(button_newTermin)) {
			...
			newTermin.setTitle("neuen Termin hinzuf�gen");
...
;			frame.setVisible(true);
		...
		if(arg0.getSource().equals(button_editTermin)) {
			...
			else showErrorDialog("Fehler!", "Kein Termin ausgew�hlt!");
		...
		if(arg0.getSource().equals(button_deleteTermin)) {
			if(terminId!=-1)
			{
				...
				SecurityDialog diag = new SecurityDialog(this,"Termin l�schen","Wollen Sie den gew�hlten Termin wirklich l�schen?");
		...
		if(arg0.getSource().equals(button_deleteTC)) {
			if(terminId!=-1)
			{
				...
				SecurityDialog diag = new SecurityDialog(this,"Termin l�schen","Wollen Sie den gew�hlten Termincontainer wirklich l�schen? Achtung: Dies l�scht auch alle Termine in diesem Termincontainer!");
				diag.setLocation(this.getLocation().x+40,this.getLocation().y+40);
				diag.setVisible(true);
	...
	{	
		...
		if(arg0.getSource().equals(button_newTermin)){
			...
			statusBar.setText("F�gt einen neuen Termin hinzu. Wenn Sie vorher auf einen Tag klicken wird dieser automatisch in das Termindatum �bernommen.");	
		}
		if(arg0.getSource().equals(button_editTermin)){
			button_editTermin.setIcon(new ImageIcon("src/images/icons/editTermin_hover.png"));
			statusBar.setText("Bearbeiten des gerade gew�hlten Termins.");	
		}
		if(arg0.getSource().equals(button_deleteTermin)){
			button_deleteTermin.setIcon(new ImageIcon("src/images/icons/deleteTermin_hover.png"));
			statusBar.setText("L�scht den gerade gew�hlten Termin.");	
		}
		if(arg0.getSource().equals(button_newTC)){
			button_newTC.setIcon(new ImageIcon("src/images/icons/neuerTC_hover.png"));
			statusBar.setText("F�gt einen neuen Termincontainer hinzu.");	
		}
		...
		if(arg0.getSource().equals(button_deleteTC)){
			...
			statusBar.setText("L�scht einen Termincontainer.");	
		}
		if(arg0.getSource().equals(button_search)){
		...
		if(arg0.getSource().equals(button_monthBack)){
			...
			statusBar.setText("Verschiebt die Ansicht um 4 Wochen zur�ck.");	
		}
		if(arg0.getSource().equals(button_weekBack)){
			button_weekBack.setIcon(new ImageIcon("src/images/icons/weekBack_hover.png"));
			statusBar.setText("Verschiebt die Ansicht um 1 Woche zur�ck.");	
		}
		if(arg0.getSource().equals(button_dayBack)){
			button_dayBack.setIcon(new ImageIcon("src/images/icons/dayBack_hover.png"));
			statusBar.setText("Verschiebt die Ansicht um 1 Tag zur�ck.");	
		}
		if(arg0.getSource().equals(button_monthNext)){
		...
		if(arg0.getSource().equals(zoomBox)){
			statusBar.setText("Aktiviert/Deaktiviert die automatische Vergr��erung eines Tages in der Monatsansicht wenn der Mauszeiger dar�bergef�hrt wird.");	
		}
		
		if(arg0.getSource().equals(listTC2)) {
			statusBar.setText("Doppelklick auf einen Eintrag zeigt den zugeh�rigen Tag im Kalender an.");
		}
		if(arg0.getSource().equals(dateJumper)) {
			statusBar.setText("Geben Sie ein Datum im Format TT.MM.JJJJ ein und best�tigen sie mit 'ENTER'");
		}
		if(arg0.getSource().equals(button_jumpToToday)) {
			statusBar.setText("Setzt den Kalender auf das heutige Datum.");
		}
		if(arg0.getSource().equals(todayList)) {
			statusBar.setText("Klick auf einen Termin �ffnet dessen Details");
		}
	}
	...
	/* Zoom-Funktion f�r das Hovern �ber die Tabelle
	 * 
	 */
	private void tableZoom()
	/* Diese Methode vergr��ert die Zelle, �ber der sich der Cursor befindet,
	 * indem die jeweilige Reihenh�he und Spaltenbreite erh�ht werden.
	 */
	{
//		 TableZoom Engine (c) 2006 by Stephe ;-) ---------------------------
			...
			try{
				...
				else
				{
					...
					catch(Exception ex)
					{
						...
						for (i=1;i<15;i++)
						{ 
							if(i==j) { k=150; } //Reihe j ist die Reihe, �ber die gerade "gehovert" wird
	...
	/* Setzt das Layout f�r die Tabelle
	 * 
	 */
	...
	/* Liest die Daten f�r die Tabelle ein
	 * 
	 */
	...
	/* Erneuert die Anzeige f�r die angezeigte Zeitspanne
	 * 
	 */
	...
	/* Diese Methode berechnet das Startdatum f�r die Monatsansicht.
	 * Je nach �bergebenem Datum wird das Startdatum so berechnet, dass es immer 
	...
	private void setModel(String view)
	{
		if (view.equals("week"))
		{
			//lblToday.setText("Keine Termine ausgew�hlt.");
			table.setDefaultRenderer(Termin[].class, new WeekRenderer(c_marker));
	...
	/*
	 * L�dt Termindetails in den unteren Teil der InfoBar
	 */
	...
	/*Liest Termine aus einer Tag-Zelle aus und f�llt sie in die Today-Liste
	 * 
	 */
		...
		if(delete)
			...
			if(deletedObject.equals("termincontainer"))
			{
				...
				try
				{
					...
					try {				
						...
						showErrorDialog("Fehler","Der Termincontainer konnte nicht gel�scht werden");
					}
			...
			if(terminId != -1){
				...
				try {				
					...
					showErrorDialog("Fehler","Der Termin konnte nicht gel�scht werden");
				}
			}	
		}
	...
	public void windowClosed(WindowEvent arg0) {
		...
		try {
			...
			System.out.println("mainFrame.windowClosed(..)::Konnte Datenbankverbindungen nicht schlie�en::"+e.toString());
		}
