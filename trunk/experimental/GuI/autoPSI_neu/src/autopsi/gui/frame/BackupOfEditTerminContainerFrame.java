...
*/
public class BackupOfEditTerminContainerFrame extends javax.swing.JFrame implements java.awt.event.MouseListener{
	...
	public BackupOfEditTerminContainerFrame(EditTerminFrame owner, int id) { //Konstruktor für das EditTermin-Frame
		super();
		this.ID = id;
		this.owner = owner;
		gdo = new GenericDAO();
	...
	public BackupOfEditTerminContainerFrame(mainFrame owner, int id) { //Konstruktor für das MainFrame
		super();
		this.ID = id;
		this.owner2 = owner;
		gdo = new GenericDAO();
