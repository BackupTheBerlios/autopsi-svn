...
*/
public class EditTerminContainer_von_stephe extends javax.swing.JFrame implements java.awt.event.MouseListener{
	...
	public EditTerminContainer_von_stephe(EditTerminFrame owner, int id) { //Konstruktor für das EditTermin-Frame
		super();
		this.ID = id;
		this.owner = owner;
		gdo = new GenericDAO();
	...
	public EditTerminContainer_von_stephe(mainFrame owner, int id) { //Konstruktor für das MainFrame
		super();
		this.ID = id;
		this.owner2 = owner;
		gdo = new GenericDAO();
